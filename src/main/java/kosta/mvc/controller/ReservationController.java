...
public class ReservationController {
	...
	public String insert(String reservName,
		...
		Reservation reser = new Reservation(null, reservName, reservPhone, null, reservType, price, state, people, 
				reservCheckin, reservCheckout, totalPet, insuranceTotal, member, camp, residence,null);
