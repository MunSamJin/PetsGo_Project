...
public class MemberAuthenticationProvider implements AuthenticationProvider {
	...
	public Authentication authenticate(Authentication auth) throws AuthenticationException {
		...
		System.out.println("provider에서 email = " + email);
		
		Member member = memberRep.findMember(email);
		System.out.println("rep 다녀온 provider member = " + member.getMemberEmail());

		if(member == null){
			throw new UsernameNotFoundException(email + "는 없는 회원입니다."); //spring exception
		}
