                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="campInsertForm" name="campInsert" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/owner/campInsert">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="campName">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">Email(이메일)</label>
                      <input type="email" class="form-control" id="campEmail" name="campEmail">
                      <span id="emailValid"></span>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">비밀번호</label>
                      <input type="password" class="form-control" id="campPassword" name="campPassword">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="campRegNo" name="campRegNo" oninput="autoHyphen(this)" maxlength="12" placeholder="'-'없이 숫자만 입력해 주세요">
                      <script>
							/* /([0-9]{3})-?([0-9]{2})-?([0-9]{5})/ */
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="campPhone" name="campPhone" oninput="autoHyphen2(this)" maxlength="13" placeholder="'-'없이 숫자만 입력해 주세요">
                      <script>
                    ...
                    <div class="form-group">
                      ...
                      <p><input type="text" class="form-control" id="sample6_postcode" name="campPost" placeholder="우편번호"></p>
                    ...
                    <div class="form-group">
                      ...
                      <p><input type="text" class="form-control" id="sample6_address" name="campAddr" placeholder="주소"></p>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="campNotify" rows="6" name="campNotify" style="white-space: pre-line;"></textarea>
                    </div>
                    <div class="form-group">
                      <label for="exampleTextarea1">소개글</label>
                      <textarea class="form-control" id="campIntro" rows="6" name="campIntro" style="white-space: pre-line;"></textarea>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputCity1">부대시설</label>
                      <input type="text" class="form-control" id="campFacility" name="campFacility" placeholder="여러개 작성시 꼭 ',' 콤마로 구분해주세요">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputCity1">체크인 시간</label>
                      <input type="text" class="form-control" id="campCheckin" name="campCheckin" placeholder="24시간 단위로 작성해주세요(24:00)">
                    </div>
                    <div class="form-group">
