              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="resiInsertForm" name="resiInsert" method="post" action="${pageContext.request.contextPath}/owner/resiInsert" 
        			...
        			<input type="hidden" name="camp" value="${secCamp.campNo}">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" id="resiType" name="resiType">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputCity1">숙소 주변 환경</label>
                      <input class="form-control" id="resiEnv" name="resiEnv" placeholder="공백없이 ','를 기준으로 작성하세요">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputCity1">숙소 바닥 형태</label>
                      <input class="form-control" id="resiGround" name="resiGround" placeholder="공백없이 ','를 기준으로 작성하세요">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputCity1">숙소 편의시설</label>
                      <input class="form-control" id="resiAmeniti" name="resiAmeniti" placeholder="공백없이 ','를 기준으로 작성하세요">
                    </div>
                    <div class="form-group">
                      <label>파일</label>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="resiIntro" rows="6" name="resiIntro" style="white-space: pre-line; overflow: auto"></textarea>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputCity1">가격</label>
                      <input class="form-control" id="resiPrice" name="resiPrice" >
                    </div>
                    <div class="form-group">
                      <label for="exampleInputCity1">총 제한 인원</label>
                      <input class="form-control" id="resiPeople" name="resiPeople" >
                    </div>
                    <div class="form-group">
