                        ...
                        <c:forEach items="${boardList}" var="board">
                            ...
                            <div class="single-review-area">
                                <div class="reviewer-meta d-flex align-items-center">
                                    <img src="${pageContext.request.contextPath}/img/samjin/${fileNames[0]}"  alt="">
                                        ...
                                        <div class="review-title-ratings d-flex justify-content-between">
                                            <div class="ratings" style="margin-right: 10px;">
                                                <c:forEach items="${fileNames}" var="fileName">
                                                    <img src="${pageContext.request.contextPath}/img/samjin/${fileName}" alt="" style="height: 100px; width: 100px;">
                                                </c:forEach>
                                            </div>
