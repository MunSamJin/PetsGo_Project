  ...
  <div class="main-panel">
    <div class="content-wrapper">
      <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">문의답변 등록</h4>
                  ...
                  <form class="forms-sample" action="${pageContext.request.contextPath}/pages/qna/replyInsert">
                    <div class="form-group">
                      <label for="exampleInputName1">회원 번호 or 닉네임</label>
                      <input type="text" class="form-control" id="exampleInputName1" readonly value="${qnaNo}">
                      <%-- <input type="text" name="memberEmail" id="email" readonly value="${member.memberEmail}"> <br> --%>
                    </div>
                    <div class="form-group">
                      <label for="exampleTextarea1">문의 내용</label>
                      <textarea class="form-control" id="exampleTextarea1" rows="4"></textarea>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">문의 등록일</label>
